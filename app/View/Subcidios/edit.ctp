...
<?php echo $this->Form->create('Subcidio');?>
	<fieldset>
		<legend><?php echo __('Edit Subcidio'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Subcidio.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Subcidio.id'))); ?></li>
